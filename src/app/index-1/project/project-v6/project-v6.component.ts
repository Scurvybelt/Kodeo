...
import { AiWriterFancyBannerSectionComponent } from '../../../ai-writer/ai-writer-default/sections/ai-writer-fancy-banner-section/ai-writer-fancy-banner-section.component';
...
@Component({
  ...
  standalone: true,
  imports: [AiWriterFancyBannerSectionComponent, CarouselModule, CommonModule],
